# == Resource: lxc::container::debian::squeeze
#
...
# with the release paramter set to squeeze.
#
# === Parameters
#
# [*ensure*]
...
# === Examples
#
#  lxc::container::debian::squeeze { 'lxc_debian01':
#    ensure    => running,
...
#
define lxc::container::debian::squeeze(
    $ensure,
    $ipaddress,
    $instance      = $title,
    $rootfs        = undef,
